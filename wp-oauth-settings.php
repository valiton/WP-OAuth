...
<div class='wrap wpoa-settings'>
	...
	<div id="wpoa-settings-col1" class="wpoa-settings-column">
		<form method='post' action='options.php'>
			...
			<!-- START Login with HMS section -->
			<div id="wpoa-settings-section-login-with-hms" class="wpoa-settings-section">
			<h3>Login with Harbourmaster</h3>
			<div class='form-padding'>
			<table class='form-table'>
				<tr valign='top'>
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='wpoa_hms_api_enabled' value='1' <?php checked(get_option('wpoa_hms_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='wpoa_hms_api_id' value='<?php echo get_option('wpoa_hms_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='wpoa_hms_api_secret' value='<?php echo get_option('wpoa_hms_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
